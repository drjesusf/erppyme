...
<c:import url="../clientes/mantenimientoClientes.jsp"></c:import>	

<%-- <form:form method="POST" modelAttribute="venta" class="form-horizontal" --%>
<%-- 	name="nuevaVenta" action="nuevaVenta.htm"> --%>
...
<!-- 		<label class="control-label" for="nombre">Nombre de -->
<!-- 			Cliente</label> -->
<!-- 		<div class="controls"> -->
